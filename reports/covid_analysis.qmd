...
# Methods:
## Data
To find an answer to this question, we performed an analysis on a dataset of US daily COVID-19 data and Google search trends from January 2020 until now. The dataset contains 6 variables of relavant to our question as following:
...
#| tbl-cap: "Preview of imported raw US COVID-19 dataset."
us_covid <- read_csv("../data/raw/US.csv")
knitr::kable(head(us_covid))
```
