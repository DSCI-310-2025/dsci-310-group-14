...
#| tbl-cap: "Summary preview of US COVID-19 search trend dataset with the 5 selected variables of interest in the Variable column"
us_selected <- read_csv("../results/tables/summary.csv")
